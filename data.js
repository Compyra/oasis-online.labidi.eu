...
const HELP_DATA = {
    ...
    places: [
        ...
        {
            id: "fj", icon: "🇫🇯", continent: "oc",
            name: { en: "Fiji", nl: "Fiji", fr: "Fidji", de: "Fidschi" },
            entries: [
                {
                    id: "fj-911", cat: "emergency",
                    name: { en: "911 — Emergency", nl: "911 — Noodnummer", fr: "911 — Urgences", de: "911 — Notruf" },
                    phone: "911", tel: "911", free: true, always: true, langs: ["en", "fj"],
                    desc: {
                        en: "Fiji's national emergency number — free from every provider. Direct lines: police 917, fire 910 (National Fire Authority), Crime Stoppers 919.",
                        nl: "Het nationale noodnummer van Fiji — gratis bij elke provider. Rechtstreekse lijnen: politie 917, brandweer 910, Crime Stoppers 919.",
                        fr: "Le numéro d'urgence national des Fidji — gratuit chez tous les opérateurs. Lignes directes : police 917, pompiers 910, Crime Stoppers 919.",
                        de: "Fidschis nationale Notrufnummer — kostenlos bei jedem Anbieter. Direktwahl: Polizei 917, Feuerwehr 910, Crime Stoppers 919."
                    },
                    kw: "emergency police fire ambulance 917 910 919 crime stoppers"
                },
                {
                    id: "fj-lifeline", cat: "talk",
                    name: "Lifeline Fiji — 1543",
                    phone: "1543", tel: "1543", free: true, langs: ["en", "fj"],
                    web: "https://lifelinefiji.com/",
                    desc: {
                        en: "Fiji's crisis and suicide-prevention line — call toll-free 1543 to talk with a trained counsellor. \"Connecting people with care, from crisis to opportunities.\"",
                        nl: "De crisis- en zelfmoordpreventielijn van Fiji — bel gratis 1543 om met een opgeleide hulpverlener te praten.",
                        fr: "La ligne de crise et de prévention du suicide des Fidji — appelez gratuitement le 1543 pour parler à un écoutant formé.",
                        de: "Fidschis Krisen- und Suizidpräventionslinie — rufen Sie kostenlos 1543 an, um mit geschulten Helfern zu sprechen."
                    },
                    kw: "suicide crisis lifeline talk depression counsellor"
                }
            ]
        }
    ]
...
(function () {
    ...
    const CORE_COUNTRIES = [
        ...
        ["ki", "oc", "Kiribati", "u:999;p:992;a:994;f:993"],
        ["mh", "oc", "Marshall Islands", "u:911"],
        ["nr", "oc", "Nauru", "p:110;a:111;f:112"],
        ["pg", "oc", "Papua New Guinea", "p:112;a:111;f:110"],
        ["pw", "oc", "Palau", "u:911"],
        ["sb", "oc", "Solomon Islands", "p:999;a:111;f:988"],
        ["to", "oc", "Tonga", "u:911;p:922;a:933;f:999"],
        ["tv", "oc", "Tuvalu", "p:911;a:999;f:000"],
        ["vu", "oc", "Vanuatu", "p:111;a:115;f:113"],
        ["ws", "oc", "Samoa", "u:911"],
        ["nu", "oc", "Niue", "u:999"],
        ["tk", "oc", "Tokelau", "u:999", 1],
        ["wf", "oc", "Wallis & Futuna", "p:17;a:15;f:18;x:112"],
