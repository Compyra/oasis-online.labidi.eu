...
- **08-08** v10: domain move → **help.labidi.eu** (CNAME, canonical, hreflang ×6, og:url, JSON-LD, sitemap, robots, 404, README, labidi.eu portfolio link). Brand keeps "Oasis Online" + small `.brand-domain` subtitle "help.labidi.eu" underneath. Contact e-mail still oasis-online@labidi.eu — switch to help@labidi.eu once that alias exists.
